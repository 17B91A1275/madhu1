...
<input type='text' name='uname' id="uname" required=""><br></td>
...
<td>
<input type='text' name='number'id="number" required=""></td>
</tr>-->
            <!--<input type="submit" name="search" value="Filter"><br><br>-->
		

<!--<label for="bloodgrp" ><b>Enter Blood Group:</b></label>

<select name="valueToSearch" id="valueToSearch">
...
<label for="area"><b>Enter Location:</b></label>
</td>-->
 <!--<input type="submit" name="search" value="Filter"><br><br>-->
 ...
 <form action="" method="post">
           <label> Enter Blood Group:</label>
            <input type="text" name="valueToSearch" placeholder="Enter Blood Group"><br><br>
